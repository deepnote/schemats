    ...
    describe('generateTableInterface', () => {
        ...
        it('table with columns', () => {
            const tableInterface = Typescript.generateTableInterface('tableName', {
                col1: {udtName: 'name1', nullable: false, primary: false},
                col2: {udtName: 'name2', nullable: false, primary: false}
            }, options)
            assert.equal(tableInterface,
                '\n' +
                '        export interface tableName {\n' +
        ...
        it('table with reserved columns', () => {
            const tableInterface = Typescript.generateTableInterface('tableName', {
                string: {udtName: 'name1', nullable: false, primary: false},
                number: {udtName: 'name2', nullable: false, primary: false},
                package: {udtName: 'name3', nullable: false, primary: false}
            }, options)
            assert.equal(tableInterface,
                '\n' +
                '        export interface tableName {\n' +
    ...
    describe('generateTableTypes', () => {
        ...
        it('with table definitions', () => {
            const tableTypes = Typescript.generateTableTypes('tableName', {
                col1: {udtName: 'name1', nullable: false, tsType: 'string', primary: false},
                col2: {udtName: 'name2', nullable: false, tsType: 'number', primary: false}
            }, options)
            assert.equal(tableTypes,
                '\n' +
                '        export namespace tableNameFields {' +
        ...
        it('with nullable column definitions', () => {
            const tableTypes = Typescript.generateTableTypes('tableName', {
                col1: {udtName: 'name1', nullable: true, tsType: 'string', primary: false},
                col2: {udtName: 'name2', nullable: true, tsType: 'number', primary: false}
            }, options)
            assert.equal(tableTypes,
                '\n' +
                '        export namespace tableNameFields {' +
